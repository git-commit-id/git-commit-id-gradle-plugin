...
public class GitCommitIdPluginExtension {
     ...
     * {@link #generateGitPropertiesFilename}, to configure the format (json, properties, ...)
     * of this file refer to {@link #generateGitPropertiesFormat}.
     */
     ...
     * {@link #generateGitPropertiesFile}, to configure the format (json, properties, ...)
     * of this file refer to {@link #generateGitPropertiesFormat}.
     */
    @OutputFile
     ...
     * {@link #propertyPrefix}{@code .commit.id.describe}.
     */
     ...
     * {@link #generateGitPropertiesFile} and to configure the location
     * of the properties file refer to {@link #generateGitPropertiesFilename}.
     *
     ...
     *
     * <p>Refer to {@link #exportDateFormatTimeZone} if you want to change the time-zone.
     */
    Property<String> exportDateFormat;

    /**
     * Allows to configure the time zone which is utilized for {@link #exportDateFormat}.
     *
     ...
     * The directory can be configured by {@link #dotGitDirectory}.
     ...
     * maximum timeout to wait for any native command. Refer to {@link #nativeGitTimeoutInMs}.
     */
    ...
    /**
     * Constructs a lazy property for the given project of type Boolean
     * with the specified convention.
     *
     * @param project The project that is used to construct the lazy property.
     * @param convention The convention (default value) for the lazy property.
     * @return A lazy property for the given project of type Boolean with the specified convention.
     */
    ...
    /**
     * Constructs a lazy property for the given project of type String
     * with the specified convention.
     *
     * @param project The project that is used to construct the lazy property.
     * @param convention The convention (default value) for the lazy property.
     * @return A lazy property for the given project of type String with the specified convention.
     */
    ...
    /**
     * Constructs a lazy property for the given project of type Integer
     * with the specified convention.
     *
     * @param project The project that is used to construct the lazy property.
     * @param convention The convention (default value) for the lazy property.
     * @return A lazy property for the given project of type Integer with the specified convention.
     */
    ...
    /**
     * Constructs a lazy property for the given project of type Long
     * with the specified convention.
     *
     * @param project The project that is used to construct the lazy property.
     * @param convention The convention (default value) for the lazy property.
     * @return A lazy property for the given project of type Long with the specified convention.
     */
    ...
    /**
     * Constructs a lazy list property for the given project of type String
     * with an empty list as convention.
     *
     * @param project The project that is used to construct the lazy property.
     * @return
     *     A lazy list property for the given project of type String
     *     with an empty list as convention.
     */
     ...
     *
     * @param project The project for which the default values should be setup for.
     */
